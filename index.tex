...
\paragraph{}
Our mission is to bring simple and managable sulutions to our customers based on Erlang/OTP.
%HEVEA \end{divstyle}
...
Erlang versions of the LDAP and SyncML servers was our first products. Now we
creating SaaS social Feed Server with storage and subscription services along with
Fast Comet Server /w WebSockets and Web Framework with outstanding performance.
%HEVEA \end{divstyle}
%HEVEA \end{divstyle}
...
small prototyping, code review or consulting.
%HEVEA \end{divstyle}
