...
Sources: \footahref{https://synrc.github.io/ml_language/}{synrc.github.io/ml_language}
%HEVEA \end{divstyle}
...
Sources: \footahref{https://github.com/synrc/research-ch}{research/ch}
%HEVEA \end{divstyle}

%HEVEA \begin{divstyle}{block}
\section*{\footahref{https://synrc.com/research/io/index.htm}{Io}}
\paragraph{}
Synrc Io for CLR --- one of simplest but very
powerful in potential languages.

Sources: \footahref{https://github.com/synrc/research-io}{research/io}
%HEVEA \end{divstyle}



%HEVEA \begin{divstyle}{block}
\section*{\footahref{https://synrc.com/client/chat/haiku}{Haiku Chat}}
\paragraph{}
...
Sources: \footahref{https://github.com/synrc/haiku-chat-client}{client/chat/haiku}
%HEVEA \end{divstyle}

%HEVEA \begin{divstyle}{block}
\section*{\footahref{https://synrc.com/client/sync/windows}{Windows Sync}}
\paragraph{}
...
More: \footahref{https://synrc.com/publications/cat}{publications/cat}
%HEVEA \end{divstyle}
