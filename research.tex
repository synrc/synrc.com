...
\paragraph{}
    Here is the CAP switch :) If it is the case that AP capabilities are nessesary for our storage we use Riak (CoSQL).
    For CA capabilities we use VoltDB (SQL) which is not an Erlang product though.
...
\paragraph{}
    ...
    For products whitch require pure TCP listeners and switchable protocols we use Ranch.
