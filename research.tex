...
\paragraph{}
    ...
    Just check our Spawnproc stack which is already using for
    serving millions of E-banking customers in Eastern Europe.
    \footahref{https://spawnproc.github.io/bpe/}{BPE} workflow engine and
    \footahref{https://spawnproc.github.io/upl/}{UPL} processing language
    are lightweight to undestood and yet manageable.
%HEVEA \end{divstyle}
